...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new guoShuai.Lua.LuaViewBehaviour.delLuaAwake(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(guoShuai.Lua.LuaViewBehaviour.delLuaStart))
			{
			    return new guoShuai.Lua.LuaViewBehaviour.delLuaStart(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(guoShuai.Lua.LuaViewBehaviour.delLuaUpdate))
			{
			    return new guoShuai.Lua.LuaViewBehaviour.delLuaUpdate(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(guoShuai.Lua.LuaViewBehaviour.delLuaOnDestroy))
			{
			    return new guoShuai.Lua.LuaViewBehaviour.delLuaOnDestroy(__Gen_Delegate_Imp1);
			}
